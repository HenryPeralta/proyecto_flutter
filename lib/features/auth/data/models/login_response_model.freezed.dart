...
class _$LoginResponseModelImpl extends _LoginResponseModel {
  ...
  @override
  String toString() {
    return 'LoginResponseModel(id: $id, username: $username, email: $email, firstName: $firstName, lastName: $lastName, accessToken: $accessToken, refreshToken: $refreshToken, image: $image)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, username, email, firstName,
      lastName, accessToken, refreshToken, image);
...
abstract class _LoginResponseModel extends LoginResponseModel {
  const factory _LoginResponseModel(
      ...
      final String? image}) = _$LoginResponseModelImpl;
