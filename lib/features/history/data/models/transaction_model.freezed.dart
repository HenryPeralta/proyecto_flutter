...
class _$TransactionModelImpl extends _TransactionModel {
  ...
  @override
  String toString() {
    return 'TransactionModel(id: $id, userId: $userId, type: $type, amountInCents: $amountInCents, description: $description, createdAt: $createdAt, status: $status, currency: $currency)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, type, amountInCents,
      description, createdAt, status, currency);
...
abstract class _TransactionModel extends TransactionModel {
  const factory _TransactionModel(
      ...
      final String currency}) = _$TransactionModelImpl;
