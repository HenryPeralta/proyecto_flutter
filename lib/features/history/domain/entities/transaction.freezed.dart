...
class _$TransactionImpl extends _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(id: $id, userId: $userId, type: $type, amountInCents: $amountInCents, description: $description, createdAt: $createdAt, status: $status, currency: $currency)';
  }
...
abstract class _Transaction extends Transaction {
  const factory _Transaction(
      ...
      final String currency}) = _$TransactionImpl;
